...
Feature: Searches that contain wildcard matches
  ...
  Scenario: Searching with a complex wildcard query fails
    ...
    Then this warning is reported by api: Regular expression is too complex. Learn more about simplifying it [https://www.mediawiki.org/wiki/Special:MyLanguage/Help:CirrusSearch/RegexTooComplex here].
