...
class ConfigDump extends ApiBase {
	...
	public static $PUBLICLY_SHAREABLE_CONFIG_VARS = [
		CirrusConfigNames::DisableUpdate,
		CirrusConfigNames::ConnectionAttempts,
		CirrusConfigNames::SlowSearch,
		CirrusConfigNames::UseExperimentalHighlighter,
		CirrusConfigNames::OptimizeIndexForExperimentalHighlighter,
		CirrusConfigNames::NamespaceMappings,
		CirrusConfigNames::ExtraIndexes,
		CirrusConfigNames::FetchConfigFromApi,
		CirrusConfigNames::UpdateShardTimeout,
		CirrusConfigNames::ClientSideUpdateTimeout,
		CirrusConfigNames::SearchShardTimeout,
		CirrusConfigNames::MaintenanceTimeout,
		CirrusConfigNames::PrefixSearchStartsWithAnyWord,
		...
		CirrusConfigNames::MoreAccurateScoringMode,
		CirrusConfigNames::PhraseSuggestUseText,
		CirrusConfigNames::PhraseSuggestUseOpeningText,
		CirrusConfigNames::IndexedRedirects,
		CirrusConfigNames::LinkedArticlesToUpdate,
		CirrusConfigNames::Weights,
		CirrusConfigNames::NearMatchWeight,
		CirrusConfigNames::StemmedWeight,
		CirrusConfigNames::NamespaceWeights,
		CirrusConfigNames::DefaultNamespaceWeight,
		CirrusConfigNames::TalkNamespaceWeight,
		CirrusConfigNames::LanguageWeight,
		CirrusConfigNames::PreferRecentDefaultDecayPortion,
		CirrusConfigNames::PreferRecentUnspecifiedDecayPortion,
		CirrusConfigNames::PreferRecentDefaultHalfLife,
		CirrusConfigNames::MoreLikeThisConfig,
		CirrusConfigNames::InterwikiSources,
		CirrusConfigNames::RefreshInterval,
		CirrusConfigNames::FragmentSize,
		CirrusConfigNames::IndexAllocation,
		CirrusConfigNames::FullTextQueryBuilderProfile,
		CirrusConfigNames::RescoreProfile,
		CirrusConfigNames::PrefixSearchRescoreProfile,
		CirrusConfigNames::SimilarityProfile,
		CirrusConfigNames::CrossProjectProfiles,
		CirrusConfigNames::CrossProjectOrder,
		CirrusConfigNames::CrossProjectSearchBlockList,
		CirrusConfigNames::ExtraIndexBoostTemplates,
		CirrusConfigNames::EnableCrossProjectSearch,
		CirrusConfigNames::EnableAltLanguage,
		CirrusConfigNames::EnableArchive,
		CirrusConfigNames::UseIcuFolding,
		CirrusConfigNames::UseIcuTokenizer,
		CirrusConfigNames::PhraseSuggestProfiles,
		CirrusConfigNames::CrossProjectBlockScorerProfiles,
		CirrusConfigNames::SimilarityProfiles,
		CirrusConfigNames::CompletionProfiles,
		CirrusConfigNames::CompletionSettings,
		CirrusConfigNames::CompletionSuggesterUseDefaultSort,
		// All the config below was added when moving this data
		// from CirrusSearch config to a static array in this class
		CirrusConfigNames::DevelOptions,
		CirrusConfigNames::PrefixIds,
		CirrusConfigNames::MoreLikeThisFields,
		CirrusConfigNames::MoreLikeThisTTL,
		CirrusConfigNames::FiletypeAliases,
		CirrusConfigNames::DefaultCluster,
		CirrusConfigNames::ClientSideConnectTimeout,
		CirrusConfigNames::ReplicaGroup,
		CirrusConfigNames::ExtraBackendLatency,
		CirrusConfigNames::AllowLeadingWildcard,
		CirrusConfigNames::ClientSideSearchTimeout,
		CirrusConfigNames::StripQuestionMarks,
		CirrusConfigNames::FullTextQueryBuilderProfiles,
		CirrusConfigNames::EnableRegex,
		CirrusConfigNames::WikimediaExtraPlugin,
		CirrusConfigNames::RegexMaxDeterminizedStates,
		CirrusConfigNames::MaxIncategoryOptions,
		CirrusConfigNames::EnablePhraseSuggest,
		CirrusConfigNames::ClusterOverrides,
		CirrusConfigNames::RescoreProfiles,
		CirrusConfigNames::RescoreFunctionScoreChains,
		CirrusConfigNames::NumCrossProjectSearchResults,
		CirrusConfigNames::LanguageToWikiMap,
		CirrusConfigNames::WikiToNameMap,
		CirrusConfigNames::IncLinksAloneW,
		CirrusConfigNames::IncLinksAloneK,
		CirrusConfigNames::IncLinksAloneA,
		CirrusConfigNames::QueryStringMaxDeterminizedStates,
		CirrusConfigNames::ElasticQuirks,
		CirrusConfigNames::PhraseSuggestReverseField,
		CirrusConfigNames::BoostTemplates,
		CirrusConfigNames::IgnoreOnWikiBoostTemplates,
		...
		CirrusConfigNames::FallbackProfile,
	...
	private static $PROFILES = [
		CirrusConfigNames::PhraseSuggestProfiles => SearchProfileService::PHRASE_SUGGESTER,
		CirrusConfigNames::CrossProjectBlockScorerProfiles => SearchProfileService::CROSS_PROJECT_BLOCK_SCORER,
		CirrusConfigNames::SimilarityProfiles => SearchProfileService::SIMILARITY,
		CirrusConfigNames::RescoreFunctionChains => SearchProfileService::RESCORE_FUNCTION_CHAINS,
		CirrusConfigNames::CompletionProfiles => SearchProfileService::COMPLETION,
		CirrusConfigNames::FullTextQueryBuilderProfiles => SearchProfileService::FT_QUERY_BUILDER,
		CirrusConfigNames::RescoreProfiles => SearchProfileService::RESCORE,
	];
