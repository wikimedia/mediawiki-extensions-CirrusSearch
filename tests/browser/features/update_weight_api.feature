...
Feature: Page updates trigger appropriate weight updates in newly linked and unlinked articles
  ...
  Scenario: Pages weights are updated when new pages link to them
    ...
    Then within 20 seconds api searching for WeightedLink%{epoch} yields WeightedLink%{epoch} 2 as the first result
  ...
  Scenario: Pages weights are updated when links are removed from them
    ...
    Then within 20 seconds api searching for WeightedLinkRemoveUpdate%{epoch} yields WeightedLinkRemoveUpdate%{epoch} 1 as the first result
    ...
    Then within 20 seconds api searching for WeightedLinkRemoveUpdate%{epoch} yields WeightedLinkRemoveUpdate%{epoch} 2 as the first result
  ...
  Scenario: Pages weights are updated when new pages link to their redirects
    ...
    Then within 20 seconds api searching for WeightedLinkRdir%{epoch} yields WeightedLinkRdir%{epoch} 2 as the first result
  ...
  Scenario: Pages weights are updated when links are removed from their redirects
    ...
    Then within 20 seconds api searching for WLRURdir%{epoch} yields WLRURdir%{epoch} 1 as the first result
    ...
    Then within 20 seconds api searching for WLRURdir%{epoch} yields WLRURdir%{epoch} 2 as the first result
  ...
  Scenario: Redirects to redirects don't count in the score
    ...
    Then within 20 seconds api searching for WLDoubleRdir%{epoch} yields WLDoubleRdir%{epoch} 2 as the first result
